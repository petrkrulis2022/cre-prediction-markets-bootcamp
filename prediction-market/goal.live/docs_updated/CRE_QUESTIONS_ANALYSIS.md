...
**Context:** Smart contract is real with exact function signatures; Copilot asking critical CRE questions
**Your core question:** Why does CRE need an oracle address? What data does CRE actually fetch?
